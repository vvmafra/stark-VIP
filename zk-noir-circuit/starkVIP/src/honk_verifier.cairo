...
mod UltraStarknetZKHonkVerifier {
    ...
    use super::{vk, VK_HASH, precomputed_lines, run_GRUMPKIN_ZK_HONK_SUMCHECK_SIZE_12_PUB_17_circuit, run_GRUMPKIN_ZKHONK_PREP_MSM_SCALARS_SIZE_12_circuit, run_GRUMPKIN_ZK_HONK_EVALS_CONS_INIT_SIZE_12_circuit, run_GRUMPKIN_ZK_HONK_EVALS_CONS_LOOP_SIZE_12_circuit, run_GRUMPKIN_ZK_HONK_EVALS_CONS_DONE_SIZE_12_circuit, is_on_curve_bn254};
...
full_proof.proof.lookup_read_tags.into(), // Proof point 9
            ...
            let mut scalars: Span<u384> = array![scalar_2,
            scalar_3,
            scalar_4,
            scalar_5,
            scalar_6,
